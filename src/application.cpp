...
#ifdef __EMSCRIPTEN__
    emscripten_set_main_loop_arg(_main_loop, this, 0, true);
#else
    while (m_is_running)
    {
        _frame();
...
#ifdef __EMSCRIPTEN__
void Application::_main_loop(void* arg)
{
    static_cast<Application*>(arg)->_frame();
}
#endif
...
bool Application::_initialize()
{
    ...
    Uint32 flags = SDL_INIT_TIMER | SDL_INIT_VIDEO | SDL_INIT_EVENTS;
